...
{
    public static class AlfaCardNumberGenerator
    {
        public static string GenerateNewCardNumber(CardType cardType)
        {
            string startBin;
            ...
            startBin = Constants.AlfaBins.FirstOrDefault(x => x.StartsWith(startBin));

...
namespace Server.Test.Controllers
{
    public class TransactionsControllerTest : ControllerTestBase
    {
        ...
        public void GetTransactions_ValidData_ReturnCorrectListResult(string value)
        {
            ...
            Assert.All(
                ...
                dto =>
                {
                    ...
                    Assert.Equal(2019, dto.DateTime.Year);
                });
        }
        ...
        public void PostTransactions_ValidData_ReturnCreatedResult()
        {
            ...
            Assert.Equal(
                fakePostTransactionDto.To.Substring(fakePostTransactionDto.To.Length - 4, 4),
            ...
            Assert.Equal(2019, transaction.DateTime.Year);
        }
        ...
        public void PostTransactions_InternalError_ReturnBadRequest()
        {
            ...
            _bankServiceMock.Setup(
                    r => r.TryTransferMoney(
                        _user,
                        fakeTransactionDto.Sum,
                        fakeTransactionDto.From,
        ...
        [Fact]
        public void PostTransactions_MappingFail_ReturnBadRequest()
        {
            // Arrange
            var fakeCardFrom = _fakeCards.First();
            var fakeCardTo = _fakeCards.ElementAt(1);
